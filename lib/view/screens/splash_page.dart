...
class _SplashPageState extends ConsumerState<SplashPage> {
  ...
  hideUIOverlay() => SystemChrome.setEnabledSystemUIMode(SystemUiMode.manual, overlays: []);

  // Exit Full Screen
  showUIOverlay() => SystemChrome.setEnabledSystemUIMode(SystemUiMode.manual, overlays: SystemUiOverlay.values);
  ...
  void initState() {
    Future.delayed(Duration.zero).then((value) {
      ref.watch(getIsAuthenticatedProvider).when(
          ...
          error: (error, stacktrace) => Navigator.of(context).pushReplacementNamed(SignUpPage.route),
          loading: () => Navigator.of(context).pushReplacementNamed(Loading.route));
    });
    super.initState();
  }
